// ===== src/data/banknote100kData.ts =====
const BANKNOTE_100K_INFO = {
    nominal: 'Rp100.000',
    nominalNumeric: 100000,
    ...
    pahlawanUtama: 'Dr. (H.C.) Ir. Soekarno & Dr. (H.C.) Drs. Mohammad Hatta',
    gelarPahlawan: 'Dwi Tunggal Proklamator Kemerdekaan RI',
    flora: 'Bunga Anggrek Bulan (Phalaenopsis amabilis)',
    faunaDanAlam: 'Kepulauan Raja Ampat (Papua Barat)',
    tari: 'Tari Topeng Betawi (DKI Jakarta)',
    deskripsiRingkas: 'Pecahan tertinggi Republik Indonesia yang menggambarkan semangat Proklamasi Kemerdekaan 1945, kekayaan alam bahari Raja Ampat, dan keluhuran budaya nusantara.'
};
const HOTSPOTS_100K_FRONT = [
    {
        id: 'hero',
        top: '48%',
        left: '52%',
        title: 'Pahlawan Proklamator Soekarno - Hatta',
        desc: 'Gambar utama Dr. (H.C.) Ir. Soekarno & Dr. (H.C.) Drs. Mohammad Hatta dengan cetak intaglio bertekstur timbul dan relief sangat halus saat diraba.',
        category: 'tokoh',
        side: 'front',
        history: 'Soekarno dan Mohammad Hatta ditampilkan sebagai tokoh utama pada sisi depan uang Rupiah.',
    },
    {
        id: 'nominal_top',
        top: '20%',
        left: '14%',
        title: 'Angka Nominal 100000',
        desc: 'Angka nominal tebal dan jelas dengan cetak intaglio bertekstur kasar saat diraba jari.',
        category: 'keamanan',
        side: 'front',
        history: 'Angka nominal besar membantu mengenali pecahan dengan cepat dan menjadi bagian dari elemen cetak keamanan.',
    },
    {
        id: 'garuda',
        top: '24%',
        ...
        category: 'keamanan',
        side: 'front',
        history: 'Garuda Pancasila menjadi lambang negara pada desain uang Rupiah Indonesia.',
    },
    {
        id: 'bi_spark',
        top: '56%',
        left: '12%',
        title: 'BI-SPARK (Bunga Anggrek Bulan)',
        desc: 'Fitur keamanan optik canggih berupa ornamen Bunga Anggrek Bulan yang akan berubah warna (color shifting) dari keemasan menjadi kehijauan saat dilihat dari berbagai sudut pandang.',
        category: 'keamanan',
        side: 'front',
        history: 'Ornamen BI-SPARK menggunakan elemen optik yang dirancang untuk memberi efek visual saat sudut pandang berubah.',
    },
    {
        id: 'watermark',
        top: '38%',
        left: '26%',
        title: 'Tanda Air & Electrotype 100',
        desc: 'Tanda air dan electrotype angka "100" ditampilkan sebagai fitur tembus cahaya dari gambar uang; tidak ada logo logo sintetis yang ditambahkan di atas gambar.',
        category: 'watermark',
        side: 'front',
        history: 'Tanda air dan electrotype digunakan sebagai fitur pengaman yang diamati dengan menerawang uang.',
    },
    {
        id: 'rectoverso',
        top: '64%',
        ...
        category: 'keamanan',
        side: 'front',
        history: 'Rectoverso adalah elemen gambar yang saling melengkapi antara sisi depan dan belakang ketika diterawang.',
    },
    {
        id: 'blind_code_left',
        top: '50%',
        ...
        desc: 'Sepasang garis taktil kasar ganda di sisi kiri untuk mempermudah penyandang disabilitas netra mengidentifikasi pecahan Rp100.000.',
        category: 'keamanan',
        side: 'front',
        history: 'Kode taktil di tepi uang membantu identifikasi pecahan melalui rabaan.',
    },
    {
        id: 'blind_code_right',
        top: '50%',
    ...
    },
    {
        ...
        desc: 'Benang pengaman menyerupai anyaman yang memuat teks mikro "BI 100" dan memancarkan efek gerak dinamis saat dimiringkan serta berpendar di bawah sinar UV.',
        category: 'keamanan',
        side: 'front',
        history: 'Benang pengaman merupakan salah satu fitur keamanan yang dapat diamati pada uang Rupiah.',
    }
];
const HOTSPOTS_100K_BACK = [
    {
        id: 'tari_topeng',
        top: '46%',
        left: '48%',
        title: 'Tari Topeng Betawi',
        desc: 'Tarian tradisional khas DKI Jakarta yang dinamis dengan penari mengenakan topeng kayu berkarakter ceria dan ekspresif.',
        category: 'budaya',
        side: 'back',
        history: 'Tari Topeng Betawi menjadi unsur budaya yang ditampilkan pada sisi belakang pecahan Rp100.000.',
    },
    {
        id: 'raja_ampat',
        top: '32%',
        ...
        desc: 'Keindahan gugusan pulau karang dan keanekaragaman hayati bawah laut kelas dunia di Papua Barat.',
        category: 'budaya',
        side: 'back',
        history: 'Raja Ampat menjadi unsur alam Indonesia yang ditampilkan pada sisi belakang pecahan Rp100.000.',
    },
    {
        id: 'anggrek_bulan',
        top: '16%',
        left: '26%',
        title: 'Bunga Anggrek Bulan (Puspa Pesona)',
        desc: 'Salah satu bunga nasional Indonesia (Puspa Pesona) yang melambangkan keanggunan dan keindahan nusantara.',
        category: 'budaya',
        side: 'back',
        history: 'Anggrek Bulan menjadi unsur flora Indonesia yang ditampilkan pada sisi belakang pecahan Rp100.000.',
    },
    {
        id: 'serial_number',
        top: '76%',
        left: '26%',
        title: 'Nomor Seri Asimetris Berpendar',
        desc: 'Nomor seri dengan ukuran font membesar dari kiri ke kanan yang akan berpendar hijau-kekuningan di bawah sinar ultraviolet 365nm.',
        category: 'keamanan',
        side: 'back',
        history: 'Nomor seri berfungsi sebagai identitas unik lembar uang dan menjadi bagian dari fitur keamanan.',
    },
    {
        id: 'logo_bi_back',
        top: '20%',
        left: '82%',
        title: 'Tulisan BANK INDONESIA & Logo',
        desc: 'Tulisan resmi penerbit mata uang legal Republik Indonesia dengan ketajaman mikroteks ultra tinggi.',
        category: 'keamanan',
        side: 'back',
        history: 'Tulisan BANK INDONESIA dan logo penerbit menjadi bagian penting pada sisi belakang uang.',
    },
    {
        id: 'microtext_back',
        top: '82%',
        left: '84%',
        title: 'Mikroteks "BANK INDONESIA 100000"',
        desc: 'Susunan teks mini yang hanya dapat dibaca menggunakan kaca pembesar, sulit dipalsukan oleh printer konvensional.',
        category: 'keamanan',
        side: 'back',
        history: 'Mikroteks dibuat sangat kecil sebagai detail keamanan yang membutuhkan pengamatan lebih dekat.',
    }
];
const TACTILE_ZONES_100K = [
    {
        id: 'nominal',
        name: 'Angka Nominal 100000 & Huruf NKRI Timbul',
        desc: 'Terasa kasar dan tebal bergelombang karena teknik cetak Intaglio bertekanan tinggi.',
        tactileType: 'Cetak Intaglio',
        area: { x: 5, y: 10, width: 28, height: 22 }
    },
    {
        id: 'hero',
        name: 'Relief Gambar Pahlawan Soekarno & Hatta',
        desc: 'Garis-garis arsiran pada wajah, jas, dan peci pahlawan memberikan sensasi taktil timbul.',
        tactileType: 'Relief Arsiran',
        area: { x: 38, y: 15, width: 36, height: 70 }
    },
    {
        id: 'blind_left',
        name: 'Kode Tuna Netra Tepi Kiri (Sepasang Garis Ganda)',
        desc: 'Dua pasang garis tebal di tepi kiri dirancang khusus agar mudah diraba oleh penyandang disabilitas netra.',
        tactileType: 'Blind Code Ganda',
        area: { x: 0, y: 35, width: 8, height: 30 }
    },
    {
        id: 'blind_right',
        name: 'Kode Tuna Netra Tepi Kanan (Sepasang Garis Ganda)',
        desc: 'Dua pasang garis timbul di tepi kanan untuk verifikasi taktil ganda pecahan Rp100.000.',
        tactileType: 'Blind Code Ganda',
        area: { x: 92, y: 35, width: 8, height: 30 }
    },
    {
        id: 'garuda',
        name: 'Lambang Garuda Pancasila & Tulisan Bank Indonesia',
        desc: 'Cetak intaglio tebal dan bertekstur pada perisai Garuda dan frasa resmi kenegaraan.',
        tactileType: 'Intaglio Kenegaraan',
        area: { x: 74, y: 12, width: 22, height: 30 }
    }
];
const SECURITY_FEATURES_100K = [
    {
        title: '1. Gambar Utama Soekarno - Hatta',
        desc: 'Potret jelas Proklamator RI dengan cetak Intaglio timbul.',
        icon: 'fa-user-tie',
        method: 'Dilihat & Diraba'
    },
    {
        title: '2. Tanda Air (Watermark) & Electrotype 100',
        desc: 'Gambar Soekarno-Hatta & angka 100 terlihat jelas saat diterawang.',
        icon: 'fa-droplet',
        method: 'Diterawang'
    },
    {
        title: '3. Cetak Intaglio Kasar & Timbul',
        desc: 'Cetak bertekstur pada nominal, lambang Garuda, dan teks.',
        icon: 'fa-hand',
        method: 'Diraba'
    },
    {
    ...
    {
        title: '5. BI-SPARK Anggrek Bulan',
    ...
    },
    {
        ...
        desc: 'Memuat teks mikro BI 100 dan memancarkan efek dinamis.',
...
const TTS_SESSIONS_100K = [
    {
        level: 1,
        title: 'Pecahan Rp100.000 TE 2022',
        nominalText: 'Rp100.000',
        gridMap: [
            ['H', 'A', 'T', 'T', 'A'],
            ['A', '#', '#', '#', '#'],
            ['T', 'O', 'P', 'E', 'N'],
        ...
        clues: [
            { num: '1-Mendatar', text: '1. Nama Wakil Presiden Proklamator pada uang Rp100.000 (5 Huruf: HATTA)' },
            { num: '1-Menurun', text: '1. Sosok Proklamator Pertama RI: Bung ___ (4 Huruf singkatan)' },
            { num: '2-Mendatar', text: '2. Kesenian tari khas Betawi di bagian belakang: Tari ___ (5 Huruf: TOPEN/G)' },
            { num: '3-Mendatar', text: '3. Jenis bunga nasional (Puspa Pesona) di Rp100rb: Bunga ___ (5 Huruf singkatan)' }
        ]
    },
    {
        level: 2,
        title: 'Keindahan Alam & Budaya Rp100.000',
        nominalText: 'Rp100.000',
        gridMap: [
            ['R', 'A', 'J', 'A', '#'],
            ['A', '#', '#', '#', '#'],
        ...
        clues: [
            { num: '1-Mendatar', text: '1. Bagian depan nama gugusan kepulauan eksotis Papua Barat: ___ Ampat (4 Huruf)' },
            { num: '1-Menurun', text: '1. Gugusan pulau karang indah di Papua Barat (5 Huruf singkat)' },
            { num: '2-Mendatar', text: '2. Warna dominan pada uang pecahan Rp100.000 TE 2022 (5 Huruf: MERAH)' }
        ]
    },
    {
        level: 3,
...
const QUIZ_QUESTIONS_100K = [
    {
        q: 'Siapakah dua tokoh Pahlawan Nasional pada bagian depan uang pecahan Rp100.000 TE 2022?',
        opt: [
        ...
        ans: 0,
        explanation: 'Dr. (H.C.) Ir. Soekarno dan Dr. (H.C.) Drs. Mohammad Hatta adalah Dwi Tunggal Proklamator Kemerdekaan Republik Indonesia.'
    },
    {
        q: 'Pemandangan alam spektakuler manakah yang terdapat pada sisi belakang uang Rp100.000 TE 2022?',
        opt: [
        ...
        ans: 1,
        explanation: 'Sisi belakang uang Rp100.000 memuat pemandangan alam Kepulauan Raja Ampat di Papua Barat yang terkenal dengan keindahan bahari kelas dunia.'
    },
    {
        q: 'Tarian tradisional apakah yang diabadikan pada sisi belakang uang Rp100.000 TE 2022?',
        opt: [
            'Tari Tifa',
            'Tari Gambyong',
            'Tari Topeng Betawi',
        ...
        ans: 2,
        explanation: 'Tari Topeng Betawi asal DKI Jakarta melambangkan keceriaan, dinamika, dan keteguhan budaya nusantara.'
    },
    {
        q: 'Fitur keamanan optik modern pada bunga anggrek bulan uang Rp100.000 yang dapat berubah warna saat digoyangkan disebut...?',
        opt: [
            'BI-SPARK',
            'Rectoverso',
            'Blind Code',
    ...
    {
        q: 'Apa yang terjadi pada nomor seri asimetris uang Rp100.000 jika disinari lampu Ultra Violet (365 nm)?',
        opt: [
...
const BANKNOTE_FRONT_IMAGE = 'assets/depan.spesimen.jpg';
const BANKNOTE_BACK_IMAGE = 'assets/belakang.spesimen.jpg';
const UV_REFERENCE_100K = { front: 'assets/uv-depan.spesimen.png', back: 'assets/uv-belakang.spesimen.png' };
...
const BanknoteVisual = ({ side, mode = 'normal', uvIntensity = 0, watermarkIntensity = 0, tiltAngle = 0, highlightZoneId = null, className = '', onZoneClick }) => {
    ...
    return React.createElement("div", {
        ...
        React.createElement("img", {
            src: image,
            alt: side === 'front' ? 'Uang Rp100.000 sisi depan' : 'Uang Rp100.000 sisi belakang',
...
const Bill3DScene = ({ isAutoRotate, onToggleAutoRotate, onHotspotClick, isUVActive, isScanning, onHelpClick }) => {
    ...
    // Hotspot dipasang langsung pada masing-masing muka uang agar titik sisi belakang
    // ikut berputar bersama face belakang dan tetap terlihat saat tombol Balik ditekan.
    const normalizedRotY = ((rotY % 360) + 360) % 360;
    const isFrontFacing = normalizedRotY < 90 || normalizedRotY > 270;
    const renderHotspots = (items, side) => React.createElement('div', {
        className: 'absolute inset-0 z-40 pointer-events-none',
        style: {
            transform: side === 'back' ? 'rotateY(180deg) translateZ(4px)' : 'translateZ(4px)',
            transformStyle: 'preserve-3d',
            backfaceVisibility: 'hidden'
        }
    }, items.map(hotspot => React.createElement('button', {
        key: hotspot.id, type: 'button',
        onPointerDown: e => e.stopPropagation(),
        onClick: e => { e.stopPropagation(); sound.play('coin'); onHotspotClick(hotspot); },
        className: 'absolute w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-[#ff3b5f] border-2 border-white cursor-pointer pointer-events-auto shadow-[0_0_8px_rgba(255,59,95,.85),0_0_16px_rgba(255,59,95,.45)] transition-transform hover:scale-125 animate-pulse',
        style: { top: hotspot.top, left: hotspot.left, transform: 'translate(-50%, -50%)' },
        title: hotspot.title, 'aria-label': hotspot.title
    }, React.createElement('span', { className: 'block w-1 h-1 bg-white rounded-full mx-auto mt-0.5' }))));
    ...
    return (React.createElement("section", { id: "3d-showcase-area", className: "relative flex flex-col justify-center items-center my-2 p-4 sm:p-6 rounded-2xl border-2 border-[#c5a059] overflow-hidden shadow-2xl", style: {
        ...
        React.createElement("div", { className: "absolute top-[42%] left-1/2 -translate-x-1/2 -translate-y-1/2 font-black text-6xl sm:text-8xl text-white/5 tracking-widest pointer-events-none z-0 select-none" }, "100000"),
...
const DirabaInspectorModal = ({ onClose }) => {
    ...
    const findZone = (x,y) => TACTILE_ZONES_100K.find(z => x >= z.area.x && x <= z.area.x+z.area.width && y >= z.area.y && y <= z.area.y+z.area.height);
    const handleTouch = (e) => {
...
// TE 2022 UV NOTE:
// Semua tampilan uang menggunakan foto spesimen Rp100.000 yang diberikan.
// Tampilan UV menggunakan referensi UV yang diberikan dan dipasang sebagai layer
// perbandingan agar detail kecil fluoresensi tetap terlihat saat slider digeser.
const UVInspectorModal = ({ onClose }) => {
    ...
    const normalSrc = side === 'front' ? 'assets/depan.spesimen.jpg' : 'assets/belakang.spesimen.jpg';
    const uvSrc = side === 'front' ? 'assets/uv-depan.spesimen.png' : 'assets/uv-belakang.spesimen.png';
    ...
    return React.createElement('div', { className: 'uv-modal-backdrop' },
        React.createElement('div', { className: 'uv-modal' },
            ...
            React.createElement('div', { className: 'uv-side-row' },
                React.createElement('div', null,
                    React.createElement('strong', null, `Rp100.000 • Bagian ${labelSide}`),
            ...
            React.createElement('div', {
                ...
                React.createElement('img', { className: 'uv-image uv-normal', src: normalSrc, alt: `Uang Rp100.000 bagian ${labelSide} normal` }),
                React.createElement('div', { className: 'uv-uv-layer', style: uvLayerStyle },
                    React.createElement('img', { className: 'uv-image', src: uvSrc, alt: `Uang Rp100.000 bagian ${labelSide} di bawah sinar UV` })
                ),
            ...
            React.createElement('div', { className: 'uv-info' },
                ...
                React.createElement('div', null,
                    ...
                    React.createElement('p', null, 'Sinar UV dapat membantu melihat fitur keamanan tertentu pada uang Rupiah yang tidak terlihat jelas pada cahaya biasa. Tampilan UV menggunakan gambar spesimen Rp100.000 yang disesuaikan dengan referensi UV yang kamu berikan, termasuk detail fluoresensi kecil.')
                )
            ),
...
const DiterawangInspectorModal = ({ onClose }) => {
    ...
    const features={
        watermark:{title:'Tanda Air Potret & Electrotype 100',desc:'Pada cahaya rendah hampir tidak terlihat. Semakin kuat cahaya tembus, gambar tanda air muncul lebih jelas sebagai gambar samar di dalam kertas.'},
        electrotype:{title:'Electrotype 100',desc:'Angka electrotype terlihat semakin kontras ketika cahaya menembus lembar uang dari belakang.'},
    ...
    const bill=React.createElement('div',{className:'rounded-2xl border-2 border-[#b77a18] bg-gradient-to-b from-[#6d4b13] via-[#3b2b13] to-[#171109] p-2 sm:p-4 shadow-[inset_0_0_50px_rgba(255,193,7,.22)]'},
        React.createElement('div',{className:'relative w-full max-w-[820px] mx-auto overflow-hidden rounded-xl',style:{aspectRatio:'151 / 65'}},
            React.createElement('img',{src:base,alt:'Uang Rp100.000',className:'absolute inset-0 w-full h-full object-cover',style:{filter:`brightness(${0.52+r*.55}) contrast(${.98+r*.10}) saturate(${1-r*.22})`,transition:'filter .3s ease'}}),
            ...
            React.createElement('button',{onClick:()=>select('electrotype'),className:'absolute left-[13%] bottom-[10%] px-3 py-1.5 rounded-full bg-yellow-300 text-black font-black text-[10px] sm:text-xs shadow-[0_0_20px_rgba(253,224,71,.45)]'},'• Electrotype 100'),
...
const ScannerModal = ({ onClose }) => {
    // Scanner universal: Rp1.000, Rp2.000, Rp5.000, Rp10.000,
    // Rp20.000, Rp50.000, dan Rp100.000.
    const DENOMS = {
        1000:{label:'Rp1.000',words:'Seribu Rupiah',history:'Pecahan Rp1.000 dikenali berdasarkan angka nominal yang terbaca pada lembar uang.'},
        2000:{label:'Rp2.000',words:'Dua Ribu Rupiah',history:'Pecahan Rp2.000 dikenali berdasarkan angka nominal yang terbaca pada lembar uang.'},
        5000:{label:'Rp5.000',words:'Lima Ribu Rupiah',history:'Pecahan Rp5.000 dikenali berdasarkan angka nominal yang terbaca pada lembar uang.'},
        10000:{label:'Rp10.000',words:'Sepuluh Ribu Rupiah',history:'Pecahan Rp10.000 dikenali berdasarkan angka nominal yang terbaca pada lembar uang.'},
        20000:{label:'Rp20.000',words:'Dua Puluh Ribu Rupiah',history:'Pecahan Rp20.000 dikenali berdasarkan angka nominal yang terbaca pada lembar uang.'},
        50000:{label:'Rp50.000',words:'Lima Puluh Ribu Rupiah',history:'Pecahan Rp50.000 dikenali berdasarkan angka nominal yang terbaca pada lembar uang.'},
        100000:{label:'Rp100.000',words:'Seratus Ribu Rupiah',history:'Rp100.000 TE 2022 adalah pecahan tertinggi yang ditampilkan pada Rupiah Explorer ini. Sisi depan menampilkan Soekarno-Hatta dan sisi belakang menampilkan unsur budaya dan alam Indonesia.'}
    };
    ...
    const videoRef=React.useRef(null),canvasRef=React.useRef(null),streamRef=React.useRef(null),cameraReadyRef=React.useRef(false),busyRef=React.useRef(false),ocrWorkerRef=React.useRef(null),ocrReadyRef=React.useRef(false),ocrInitRef=React.useRef(null);
    ...
    const capture=()=>{const v=videoRef.current,c=canvasRef.current;if(!v||!c||v.readyState<2||!v.videoWidth||!v.videoHeight)return null;c.width=v.videoWidth;c.height=v.videoHeight;const ctx=c.getContext('2d',{willReadFrequently:true});ctx.setTransform(1,0,0,1,0,0);ctx.imageSmoothingEnabled=true;ctx.drawImage(v,0,0,c.width,c.height);return {url:c.toDataURL('image/jpeg',0.94),width:c.width,height:c.height};};
    const initOCR=()=>{if(ocrReadyRef.current)return Promise.resolve(ocrWorkerRef.current);if(ocrInitRef.current)return ocrInitRef.current;if(!window.Tesseract)return Promise.resolve(null);ocrInitRef.current=(async()=>{try{const worker=await Tesseract.createWorker('eng');await worker.setParameters({tessedit_char_whitelist:'0123456789.,- ',preserve_interword_spaces:'1',user_defined_dpi:'260',tessedit_pageseg_mode:'6'});ocrWorkerRef.current=worker;ocrReadyRef.current=true;return worker;}catch(e){ocrInitRef.current=null;return null;}})();return ocrInitRef.current;};
    // Tiga crop cepat: seluruh uang + bagian atas + bagian bawah.
    // Nominal Rupiah yang besar biasanya muncul pada salah satu area ini.
    const makeScanCrops=cap=>new Promise(resolve=>{const img=new Image();img.onload=()=>{const W=Math.min(1500,Math.max(1100,img.naturalWidth)),H=Math.round(img.naturalHeight*(W/img.naturalWidth));const defs=[{x:0,y:0,w:1,h:1},{x:0,y:0,w:1,h:.58},{x:0,y:.42,w:1,h:.58}],out=[];for(const q of defs){const sx=Math.round(q.x*img.naturalWidth),sy=Math.round(q.y*img.naturalHeight),sw=Math.round(q.w*img.naturalWidth),sh=Math.round(q.h*img.naturalHeight),c=document.createElement('canvas');c.width=Math.max(900,Math.round(sw*(W/img.naturalWidth)));c.height=Math.max(520,Math.round(sh*(H/img.naturalHeight)));const ctx=c.getContext('2d',{willReadFrequently:true});ctx.imageSmoothingEnabled=true;ctx.drawImage(img,sx,sy,sw,sh,0,0,c.width,c.height);const im=ctx.getImageData(0,0,c.width,c.height),d=im.data;for(let i=0;i<d.length;i+=4){const g=.299*d[i]+.587*d[i+1]+.114*d[i+2],v=Math.max(0,Math.min(255,(g-126)*1.8+128));d[i]=d[i+1]=d[i+2]=v;}ctx.putImageData(im,0,0);out.push(c.toDataURL('image/png'));}resolve(out);};img.onerror=()=>resolve([cap.url]);img.src=cap.url;});
    ...
    const detectDenom=(texts)=>{const raw=(texts||[]).join(' ').toLowerCase();const cleaned=raw.replace(/[oOqQdD]/g,'0').replace(/[iIlL|]/g,'1').replace(/[zZ]/g,'2').replace(/[sS]/g,'5').replace(/[gG]/g,'6').replace(/[tT]/g,'7').replace(/[bB]/g,'8');const nums=Object.keys(DENOMS).map(Number),candidates=[];const add=(str,bonus=0)=>{const n=String(str||'').replace(/[^0-9]/g,'');if(!n)return;candidates.push({str:n,bonus});for(let len=3;len<=6;len++)if(n.length>len)for(let i=0;i<=n.length-len;i++)candidates.push({str:n.slice(i,i+len),bonus:bonus-4});};(cleaned.match(/\d[\d\s.,-]{1,9}\d/g)||[]).forEach(x=>add(x,6));(cleaned.match(/\d{3,6}/g)||[]).forEach(x=>add(x,8));let best=null;for(const c of candidates){for(const n of nums){const target=String(n);if(c.str===target){const score=108+c.bonus;if(!best||score>best.score)best={n,score,exact:true};continue;}if(c.str.length===target.length){const d=distance(c.str,target),norm=d/target.length;if(norm<=.16){const score=96-norm*42+c.bonus;if(!best||score>best.score)best={n,score,exact:false};}}}}const words=[[/seribu\s*ribu|seriburibu/,1000],[/dua\s*ribu|duaribu/,2000],[/lima\s*ribu|limaribu/,5000],[/sepuluh\s*ribu|sepuluhribu/,10000],[/dua\s*puluh\s*ribu|duapuluhribu/,20000],[/lima\s*puluh\s*ribu|limapuluhribu/,50000],[/seratus\s*ribu|seratusribu/,100000]];for(const [rx,n] of words)if(rx.test(cleaned))return {n,score:91,exact:true};return best;};
    const ocr=async cap=>{const worker=await initOCR();if(!worker)return null;const crops=await makeScanCrops(cap),founds=[];for(const crop of crops){try{const out=await worker.recognize(crop);const found=detectDenom([out?.data?.text||'']);if(found)founds.push(found);}catch(_){}}if(!founds.length)return null;const grouped={};for(const f of founds){(grouped[f.n]||(grouped[f.n]=[])).push(f);}const ranked=Object.entries(grouped).map(([n,arr])=>{const scores=arr.map(x=>x.score).sort((a,b)=>b-a),exact=arr.some(x=>x.exact),repeat=arr.length>=2;return {n:Number(n),count:arr.length,best:scores[0],avg:scores.slice(0,3).reduce((a,b)=>a+b,0)/Math.min(3,scores.length),exact,repeat};}).sort((a,b)=>(a.count-b.count)||(a.exact-b.exact)||(a.best-b.best)||(a.avg-b.avg));const top=ranked[ranked.length-1];if(!top)return null;if(top.exact&&top.best>=100)return {n:top.n,confidence:99};if(top.repeat&&top.best>=78&&top.avg>=78)return {n:top.n,confidence:Math.min(97,Math.round(top.avg))};if(top.best>=90&&top.avg>=88)return {n:top.n,confidence:Math.min(94,Math.round(top.best))};return null;};
    const enhanceCamera=async(on)=>{const st=streamRef.current;if(!st)return;const track=st.getVideoTracks()[0];if(!track)return;try{const caps=track.getCapabilities?.()||{},adv={};if(caps.focusMode&&caps.focusMode.includes('continuous'))adv.focusMode='continuous';if(on&&caps.torch)adv.torch=true;if(!on&&caps.torch)adv.torch=false;if(Object.keys(adv).length)await track.applyConstraints({advanced:[adv]});}catch(_){}};
    const analyze=async()=>{if(!cameraReadyRef.current||busyRef.current)return;busyRef.current=true;setBusy(true);setError('');setResult(null);setScanStatus('Membaca angka nominal…');await enhanceCamera(true);const cap=capture();await enhanceCamera(false);if(!cap){busyRef.current=false;setBusy(false);setError('Kamera belum siap mengambil foto. Coba lagi.');return;}setCaptured(cap.url);setFlash(true);setTimeout(()=>setFlash(false),120);const found=await ocr(cap),data=found?DENOMS[found.n]:null;setResult(data?{nominal:found.n,label:data.label,words:data.words,confidence:found.confidence,catatan:data.label+' terdeteksi dari angka nominal. Scanner tidak menebak berdasarkan warna atau ukuran uang.',sejarah:data.history}:{nominal:null,label:'Nominal tidak terdeteksi',words:'',confidence:0,catatan:'Angka nominal belum terbaca cukup jelas. Dekatkan kamera, pastikan seluruh uang masuk kotak, dan hindari pantulan cahaya.',sejarah:'Scanner menampilkan nominal hanya ketika hasil pembacaan cukup meyakinkan agar pecahan berbeda tidak salah dikenali.'});setScanStatus(data?'✓ NOMINAL TERDETEKSI • SELESAI':'⚠ NOMINAL BELUM TERBACA • COBA LAGI');busyRef.current=false;setBusy(false);};
    ...
    return React.createElement('div',{className:'fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/90 backdrop-blur-md'},React.createElement('div',{className:'relative w-full max-w-3xl rounded-3xl bg-[#081220] border-2 border-cyan-500/50 shadow-2xl text-white p-4 sm:p-6 max-h-[95vh] overflow-y-auto flex flex-col gap-4'},React.createElement('div',{className:'flex items-start justify-between border-b border-cyan-500/20 pb-3'},React.createElement('div',{className:'flex items-center gap-3'},React.createElement('div',{className:'w-11 h-11 rounded-2xl bg-cyan-950 border border-cyan-400 flex items-center justify-center text-cyan-300 text-xl'},React.createElement('i',{className:'fa-solid fa-camera'})),React.createElement('div',null,React.createElement('h3',{className:'text-base sm:text-xl font-black'},'Scan Rupiah Otomatis'),React.createElement('p',{className:'text-xs sm:text-sm text-cyan-200/80'},'Deteksi otomatis Rp1.000 – Rp100.000 dari kamera'))),React.createElement('button',{onClick:()=>{stopCamera();onClose();},className:'w-9 h-9 rounded-full bg-zinc-800 text-zinc-300 flex items-center justify-center font-bold'},'×')),React.createElement('div',{className:'rounded-xl bg-cyan-950/30 border border-cyan-400/25 p-3 text-xs'},React.createElement('b',null,'Arahkan seluruh lembar uang ke kotak dan pastikan angka nominal terlihat jelas.'),React.createElement('div',{className:'mt-1 text-cyan-100/70'},scanStatus)),photo,React.createElement('button',{onClick:analyze,disabled:!cameraReadyRef.current||busy,className:'w-full py-3 rounded-xl bg-cyan-400 hover:bg-cyan-300 disabled:opacity-50 text-slate-950 font-black text-sm'},captured?'📷 SCAN LAGI':'📷 SCAN SEKARANG'),captured&&React.createElement('div',{className:'rounded-xl border border-cyan-400/25 bg-cyan-950/20 p-3'},React.createElement('div',{className:'text-[11px] font-black text-cyan-200 mb-2'},'📸 FOTO HASIL SCAN'),React.createElement('img',{src:captured,alt:'Hasil foto scan Rupiah',className:'w-full max-h-80 object-contain rounded-lg bg-black',style:{transform:'none'}})),React.createElement('canvas',{ref:canvasRef,className:'hidden'}),error&&React.createElement('div',{className:'p-3 rounded-xl bg-red-950/60 border border-red-500 text-red-200 text-xs'},error),resultBox,React.createElement('button',{onClick:()=>{stopCamera();onClose();},className:'w-full py-3 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white font-bold text-xs'},'Tutup')));
};
...
const TTSGameModal = ({ onClose }) => {
    ...
    const activeLevel = TTS_SESSIONS_100K[currentLevelIdx];
    ...
    return React.createElement("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/85 backdrop-blur-md animate-fadeIn"},
        React.createElement("div",{className:"relative w-full max-w-md rounded-3xl bg-[#0d1527] border-2 border-indigo-500/50 shadow-[0_0_50px_rgba(99,102,241,.3)] text-white p-4 sm:p-6 max-h-[92vh] overflow-y-auto flex flex-col gap-3.5"},
            ...
            React.createElement("div",{className:"flex items-center justify-between bg-indigo-950/40 p-2 rounded-xl border border-indigo-500/30 text-xs"},
                ...
                React.createElement("button",{disabled:currentLevelIdx===TTS_SESSIONS_100K.length-1,onClick:()=>setCurrentLevelIdx(p=>p+1),className:"px-2.5 py-1 rounded bg-indigo-900/60 disabled:opacity-30 font-bold"},"Next ▶")),
            isCompleted
                ? React.createElement("div",{className:"p-4 rounded-2xl bg-indigo-950/60 border border-indigo-400 text-center flex flex-col items-center gap-2"},
                    ...
                    React.createElement("button",{onClick:()=>currentLevelIdx<TTS_SESSIONS_100K.length-1?setCurrentLevelIdx(p=>p+1):setCurrentLevelIdx(0),className:"w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 font-bold text-xs"},currentLevelIdx<TTS_SESSIONS_100K.length-1?"Lanjut Level":"Main Ulang"))
    ...
    React.useEffect(() => {
        ...
        const loop = () => {
            ...
            if (!state.gameOver) {
                ...
                ctx.fillStyle = '#b91c1c'; // Red ground for 100k theme
                ...
                // Spawn Coins (Rp100.000 notes)
                if (state.frame % 60 === 0) {
                    state.coins.push({ x: 370, y: Math.random() > 0.5 ? 95 : 130, val: 100000 });
                }
                // Spawn Obstacles
                ...
                ctx.fillText(`Tabungan Rp100k: Rp ${state.score.toLocaleString('id-ID')}`, 12, 22);
            }
        ...
        React.createElement("div", { className: "relative w-full max-w-md rounded-3xl bg-[#0b1424] border-2 border-rose-500/50 shadow-[0_0_50px_rgba(244,63,94,0.3)] text-white p-4 sm:p-6 flex flex-col gap-3.5 text-center" },
            React.createElement("div", { className: "flex items-center justify-between border-b border-rose-500/20 pb-2" },
                React.createElement("div", { className: "flex items-center gap-2" },
                    ...
                    React.createElement("h3", { className: "text-base font-black text-white" }, "Rupiah Runner 100K")),
            ...
            React.createElement("div", { className: "flex items-center justify-between gap-3 pt-1" },
                React.createElement("button", { onClick: jump, className: "flex-1 py-3.5 px-4 rounded-xl bg-amber-400 hover:bg-amber-300 active:scale-95 text-zinc-950 font-black text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg transition-all" },
                    ...
                    React.createElement("span", null, "Lompat! (Ambil Rp100k)")),
                React.createElement("button", { onClick: () => {
                        sound.play('click');
                        onClose();
...
const QuizModal = ({ onClose }) => {
    ...
    const currentQ = QUIZ_QUESTIONS_100K[currentIdx];
    const handleAnswer = (optionIdx) => {
        ...
        setTimeout(() => {
            setSelectedOpt(null);
            if (currentIdx + 1 < QUIZ_QUESTIONS_100K.length) {
        ...
        React.createElement("div", { className: "relative w-full max-w-md rounded-3xl bg-[#0a1626] border-2 border-amber-500/50 shadow-[0_0_50px_rgba(245,158,11,0.3)] text-white p-4 sm:p-6 flex flex-col gap-4" },
            ...
            isFinished ? (React.createElement("div", { className: "text-center flex flex-col items-center gap-2.5 p-3 animate-fadeIn" },
                ...
                React.createElement("p", { className: "text-xs text-zinc-300 mt-1" }, score >= 80
                    ? 'Luar biasa! Pemahaman kamu tentang uang Rupiah Rp100.000 sangat mendalam!'
        ...
        React.createElement("div", { className: "relative w-full max-w-lg rounded-3xl bg-[#0a1526] border-2 border-amber-500/50 shadow-[0_0_50px_rgba(245,158,11,0.3)] text-white p-4 sm:p-6 max-h-[92vh] overflow-y-auto flex flex-col gap-4" },
            React.createElement("div", { className: "flex items-center justify-between border-b border-amber-500/20 pb-3" },
                React.createElement("div", { className: "flex items-center gap-3" },
                    ...
                    React.createElement("div", null,
                        React.createElement("h3", { className: "text-base sm:text-lg font-black text-white" }, "8 Ciri Keamanan Uang Rp100.000"),
            ...
            React.createElement("div", { className: "space-y-2" }, SECURITY_FEATURES_100K.map((feat, idx) => (React.createElement("div", { key: idx, className: "p-3 rounded-2xl bg-slate-900/80 border border-zinc-700/60 flex items-start gap-3 hover:border-amber-400/50 transition-all" },
    ...
    return (React.createElement("main", { id: "banknote-detail-card", className: "w-full rounded-2xl bg-[rgba(248,246,240,0.96)] border-2 border-[#c5a059] p-4 sm:p-5 shadow-xl backdrop-blur-md flex flex-col gap-4 text-[#2b2b2b]" },
        React.createElement("div", { className: "w-full rounded-2xl bg-[#0b1a30] border border-[#d4af37] p-3.5 sm:p-4 flex items-center justify-between shadow-lg text-white" },
            ...
            React.createElement("div", { className: "text-center flex-1 px-2" },
                React.createElement("h2", { className: "text-xl sm:text-2xl font-black text-white tracking-wide drop-shadow" }, BANKNOTE_100K_INFO.nominal),
                React.createElement("p", { className: "text-[11px] sm:text-xs text-[#f3e5ab] font-semibold tracking-wider" },
                    BANKNOTE_100K_INFO.terbilang,
                    " \u2013 ",
                    BANKNOTE_100K_INFO.emisi)),
        ...
        React.createElement("div", { className: "w-full rounded-xl bg-[rgba(237,242,247,0.95)] border border-[#cbd5e0] p-2.5 flex justify-around text-[10.5px] sm:text-xs text-[#2d3748] font-medium" },
            React.createElement("span", null,
                ...
                " ",
                BANKNOTE_100K_INFO.ukuran),
            React.createElement("span", null,
                React.createElement("b", null, "Warna:"),
                " ",
                BANKNOTE_100K_INFO.warna),
            React.createElement("span", null,
                React.createElement("b", null, "Emisi:"),
                " ",
                BANKNOTE_100K_INFO.tanggalPengeluaran)),
        React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3.5" },
            React.createElement("div", { className: "rounded-2xl bg-white/95 border border-[#e0e0e0] p-3.5 sm:p-4 flex flex-col justify-between shadow-sm" },
                React.createElement("div", null,
                    ...
                    React.createElement("div", { className: "text-xs text-[#2b2b2b] space-y-1.5" },
                        React.createElement("div", { className: "font-black text-[#0b1a30] text-sm" }, BANKNOTE_100K_INFO.pahlawanUtama),
                        React.createElement("ul", { className: "list-disc pl-4 space-y-1 text-[11px] text-[#4a5568]" },
                            React.createElement("li", null,
                                React.createElement("b", null, "Gelar:"),
                                " ",
                                BANKNOTE_100K_INFO.gelarPahlawan),
                            React.createElement("li", null,
            ...
            React.createElement("div", { className: "rounded-2xl bg-white/95 border border-[#e0e0e0] p-3.5 sm:p-4 flex flex-col gap-2.5 shadow-sm" },
                ...
                React.createElement("div", { onClick: () => onOpenCulture("tari"), role: "button", tabIndex: 0, className: "culture-card p-2 rounded-xl bg-[#f8fafc] border border-[#e2e8f0] flex items-center gap-3" },
                    ...
                    React.createElement("div", null,
                        React.createElement("div", { className: "font-bold text-xs text-[#0b1a30]" }, "Tari Topeng Betawi"),
                ...
                React.createElement("div", { onClick: () => onOpenCulture("raja"), role: "button", tabIndex: 0, className: "culture-card p-2 rounded-xl bg-[#f8fafc] border border-[#e2e8f0] flex items-center gap-3" },
                    ...
                    React.createElement("div", null,
                        React.createElement("div", { className: "font-bold text-xs text-[#0b1a30]" }, "Kepulauan Raja Ampat"),
                        React.createElement("div", { className: "text-[10px] text-[#64748b]" }, "Gugusan pulau karang eksotis & surga bawah laut di Papua Barat."))),
                React.createElement("div", { onClick: () => onOpenCulture("anggrek"), role: "button", tabIndex: 0, className: "culture-card p-2 rounded-xl bg-[#f8fafc] border border-[#e2e8f0] flex items-center gap-3" },
                    ...
                    React.createElement("div", null,
                        React.createElement("div", { className: "font-bold text-xs text-[#0b1a30]" }, "Bunga Anggrek Bulan"),
        ...
        React.createElement("section", { className: "border-t border-[#e2e8f0] pt-3 flex flex-col gap-2.5" },
            React.createElement("div", { className: "flex items-center justify-between" },
                React.createElement("div", { className: "font-extrabold text-xs sm:text-sm text-[#0b1a30] flex items-center gap-1.5" },
                    ...
                    React.createElement("span", null, "8 Ciri Keamanan Uang Rp100.000")),
                React.createElement("button", { onClick: () => {
                        sound.play('click');
            ...
            React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs" }, SECURITY_FEATURES_100K.map((feat, idx) => (React.createElement("div", { key: idx, className: "p-2.5 rounded-xl bg-white border border-[#e2e8f0] flex items-center gap-2 text-[#2b2b2b] shadow-sm hover:border-[#c5a059] transition-all" },
...
function App() {
    ...
    return (React.createElement("div", { className: "relative min-h-screen flex justify-center py-5 px-3 sm:px-4 text-slate-900 overflow-x-hidden font-sans", style: {
            background: 'radial-gradient(circle at 50% 10%, #d99aa2 0%, #a84f5c 38%, #6f2430 72%, #3e1720 100%)'
        } },
        ...
        activeMode === 'help-3d' && (React.createElement(InfoPopUpModal, { title: "Panduan Interaksi 3D & Auto-Putar", icon: "fa-arrows-spin", category: "Fitur 3D", onClose: () => setActiveMode('none') },
            React.createElement("div", { className: "space-y-2.5" },
                React.createElement("p", null, "Uang Rupiah Rp100.000 dapat dieksplorasi secara 3 dimensi penuh:"),
        ...
        selectedHotspot && (React.createElement(InfoPopUpModal, { title: selectedHotspot.title, icon: selectedHotspot.category === 'tokoh' ? 'fa-user-tie' : selectedHotspot.category === 'budaya' ? 'fa-mountain' : 'fa-shield-halved', category: selectedHotspot.category, onClose: () => setSelectedHotspot(null) },
            React.createElement("p", { className: "text-xs sm:text-sm text-zinc-200 leading-relaxed" }, selectedHotspot.desc), selectedHotspot.history && React.createElement("div", { className: "mt-3 p-3 rounded-xl bg-black/20 border border-amber-400/15" }, React.createElement("div", { className: "text-[10px] font-black uppercase tracking-wider text-amber-300 mb-1" }, "Sejarah / konteks"), React.createElement("p", { className: "text-xs sm:text-sm text-zinc-300 leading-relaxed" }, selectedHotspot.history))))));
}
