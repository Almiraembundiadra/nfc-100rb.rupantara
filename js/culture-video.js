(() => {
  const CULTURE_VIDEOS = {
    tari: { title: 'Tari Topeng Betawi', subtitle: 'Tarian tradisional khas DKI Jakarta', file: 'video/tari-topeng-betawi.mp4', icon: 'fa-masks-theater', accent: '#b91c1c' },
    raja: { title: 'Kepulauan Raja Ampat', subtitle: 'Keindahan alam Papua Barat Daya', file: 'video/raja-ampat.mp4', icon: 'fa-water', accent: '#0e7490' },
    anggrek: { title: 'Bunga Anggrek Bulan', subtitle: 'Puspa pesona Indonesia', file: 'video/bunga-anggrek-bulan.mp4', icon: 'fa-spa', accent: '#b45309' }
  };
